...
def generate_radar_blueprint(blueprint_library):
    radar_blueprint=blueprint_library.find('sensor.other.radar')[0]
    radar_blueprint.set_attribute('horiztonal_fov',str(45))
    radar_blueprint.set_attribute('verticle_fov',str(35))
